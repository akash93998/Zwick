...
# ********************************************
# *** Scriptname:logs_transfer.ps1
# *** Author: Neeraj Kumar
# *** Version: 1.0
# *** Program file for Zwick DATA File Copy from Shared Location to Z2 dev L4 Server
# ********************************************


#Configuration variable ...
#Update the log file and logfiles folder as dynamic
$config = Get-Content 'E:\DIA_SPLUNK\Config\Config.txt' | Select -Skip 1 | ConvertFrom-StringData
...
Try
    ...
    robocopy $SRCFolderDir $TRGTFolderDir *.HTML /s /LOG+:$Logfilenamepath
